...
exports.DcaWizard = void 0;
const nestjs_telegraf_1 = require("nestjs-telegraf");
const telegraf_1 = require("telegraf");
const prisma_service_1 = require("../../database/prisma/prisma.service");
const config_1 = require("@nestjs/config");
let DcaWizard = class DcaWizard {
    prisma;
    configService;
    ...
    async step1(ctx) {
        await ctx.reply('🔁 *B2 Agent: DCA Strategy Setup*\n\n' +
    ...
    async step2(ctx) {
        ...
        ctx.wizard.state.fromToken = token;
    ...
    async step3(ctx) {
        const data = ctx.callbackQuery.data;
        const token = data.split(':')[1];
        ctx.wizard.state.toToken = token;
        await ctx.answerCbQuery();
        await ctx.reply(`How much **${ctx.wizard.state.fromToken}** per execution?`);
        ctx.wizard.next();
    }
    async step4(ctx, msg) {
        ...
        await ctx.reply(`Select Frequency:`, {
            reply_markup: {
                inline_keyboard: [
    ...
    async step5(ctx) {
        ...
        ctx.wizard.state.frequency = freq;
        await ctx.answerCbQuery();
        const state = ctx.wizard.state;
        const frontendUrl = this.configService.get('FRONTEND_URL');
        await ctx.reply(`🔁 *DCA Strategy Summary*\n\n` +
...
], DcaWizard.prototype, "step1", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], DcaWizard.prototype, "step2", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], DcaWizard.prototype, "step3", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], DcaWizard.prototype, "step4", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], DcaWizard.prototype, "step5", null);
exports.DcaWizard = DcaWizard = __decorate([
    (0, nestjs_telegraf_1.Wizard)('dca-wizard'),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService,
        config_1.ConfigService])
], DcaWizard);
//# sourceMappingURL=dca.wizard.js.map