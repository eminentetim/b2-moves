...
let RebalanceProcessor = RebalanceProcessor_1 = class RebalanceProcessor extends bullmq_1.WorkerHost {
    ...
    async process(job) {
        ...
        try {
            ...
            let baseMint = isBasePresent ? (currentPortfolio['TARDIS']?.mint || currentPortfolio['USDC']?.mint || (isDevnet ? tokens_1.TOKENS.TARDIS : tokens_1.TOKENS.USDC_MAINNET)) : (isDevnet ? tokens_1.TOKENS.TARDIS : tokens_1.TOKENS.USDC_MAINNET);
